 ...
 */
Class Galore_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Galore_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Galore_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="galore-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Galore_Customize_Section_Upsell extends WP_Customize_Section {
